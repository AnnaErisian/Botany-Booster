package blue.thejester.botanybooster.entity;
/**
 * Adapted from Botania.  Original licence text below
 */
...
public class EntityLongCorporeaSpark extends Entity implements ICorporeaSpark {

    /*CHANGE: scan range increased*/
    ...
    private static final DataParameter<Boolean> MASTER = EntityDataManager.createKey(vazkii.botania.common.entity.EntityCorporeaSpark.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> NETWORK = EntityDataManager.createKey(vazkii.botania.common.entity.EntityCorporeaSpark.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> ITEM_DISPLAY_TICKS = EntityDataManager.createKey(vazkii.botania.common.entity.EntityCorporeaSpark.class, DataSerializers.VARINT);
    private static final DataParameter<ItemStack> DISPLAY_STACK = EntityDataManager.createKey(vazkii.botania.common.entity.EntityCorporeaSpark.class, DataSerializers.ITEM_STACK);
    ...
    public EntityLongCorporeaSpark(World world) {
        super(world);
        isImmuneToFire = true;
    }
